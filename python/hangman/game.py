...
class HangmanGame(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.currentWord.setFixedSize(265,35)
        ...
        self.setWindowTitle('Hangman 20171717')
    ...
    def guessClicked(self):
        ...
        charset = self.guessedChars.text()
        ...
        if len(guessedChar) != 1 or re.match('[^a-zA-Z]', guessedChar) != None:
            return self.message.setText("Do not guess " + guessedChar)
        
        # 이미 사용한 글자인지를 판단하고, 아닌 경우 메시지 출력, 리턴
        if guessedChar in charset:
            return self.message.setText("Aleady guessed " + guessedChar)
